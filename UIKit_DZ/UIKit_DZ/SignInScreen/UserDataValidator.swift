...
protocol UserDataValidationResultReceiver: AnyObject {
    /// Передает обновленный статут возможности авторизации
    func loginAndPaswordValidationChangedTo(_ doConform: Bool)
}

/// Модель пользователя валидирующая пользовательские данные
final class UserDataValidator {
    ...
    weak var validationResultReceiver: UserDataValidationResultReceiver?
